...
const ProfileHeader = () => {
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Setting')} style={{ marginLeft: 'auto', paddingHorizontal: 10 }}>
        <Image
          source={require("../assets/img/icon_img/setting-icon.png")}
          style={{ width: 40, height: 40, borderRadius: 80 , backgroundColor: "white", }}
        />
      </TouchableOpacity>
    </View>
  );
