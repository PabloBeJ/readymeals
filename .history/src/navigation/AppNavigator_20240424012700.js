...
const ProfileHeader = () => {
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
      <TouchableOpacity onPress={() => navigation.navigate('Home')} style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
        <Image
          source={require("../assets/img/LogoReadyMeals.jpg")}
          style={{ width: 40, height: 40, borderRadius: 80 }}
        />
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Setting')}>
        <Image
          ...
          style={{ width: 40, height: 40, borderRadius: 80, marginLeft: -700}}
        />
      </TouchableOpacity>
    </View>
  );
