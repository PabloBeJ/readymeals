...
export default function EditScreen() {
    ...
    return (
        <View style={globalStyles.container}>
            ...
            <View style={styles.row}>
            <TouchableOpacity onPress={uploadImage} style={[styles.controlButton, styles.row, { marginTop: 20 }]}>
            ...
            <TouchableOpacity onPress={uploadImage} style={[styles.controlButton, styles.row, { marginTop: 20, marginLeft: 20 }]}>
                <Image source={require("../assets/img/icon_img/delete-icon.png")} style={[globalStyles.imageIcon , {marginTop: -30}]} />
                <Text style={globalStyles.controlButtonText}>Cancel</Text>
            </TouchableOpacity>
            </View>
        </View>
