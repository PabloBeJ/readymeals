...
export default function EditScreen() {
    ...
    return (
        <View style={globalStyles.container}>
            {/* Display the title */}
            <Text style={[globalStyles.title, styles.titleText]}>{h1Title}</Text>
            <View>
                {/* Preview Image */}
...
const styles = StyleSheet.create({
    titleText: {
        ...
        // Add any additional styles you want for the title text
    },
    image: {
        width: 380,
        height: 380,
    ...
    // Add any additional styles you want for other elements
});
