...
export default function CameraScreen() {
  ...
  const text = useState("Upload Image"); // State to hold userId
  ...
  const takePhoto = async () => {
    ...
    if (!result.cancelled && result.assets) {
      ...
      console.log('Image Uri success ' + uri + "Redirecting  ..."); 
      navigation.navigate('Edit', { imageUri: uri, type: 'Upload Image', userId: userId }); 
    } else {
